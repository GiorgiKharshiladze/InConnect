...
def sendMessage(fbid, recieved_message):
	...
	response_msg = json.dumps({"message":{"attachment":{"type":"template","payload":{"template_type":"button","text":"What do you want to do next?","buttons":[{"type":"web_url","url":"https://www.messenger.com","title":"Visit Messenger"}]}}}}) # "message":{"text":recieved_message}})
