...
def sendMessage(fbid, recieved_message):
	...
	response_msg = json.dumps({"recipient":{"id":fbid},"message":{"text":"Here is a quick reply","quick_replies":[{"content_type":"text","title":"Search"}]}}) #"message":{"text":recieved_message}})
